...
Use when:
- You want Paperclip to invoke IronClaw over the Gateway WebSocket protocol.
- You want the aistack root orchestrator to manage a Paperclip agent through the IronClaw gateway.
